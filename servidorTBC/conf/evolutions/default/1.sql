...
create table reporte (
  id                        bigint auto_increment not null,
  fecha                     varchar(255),
  tipo_accidente_mas_comun  varchar(255),
  conductor_mas_efectivo    bigint,
  conductor_menos_efectivo  bigint,
  tiempo_promedio_ruta      double,
  tiempo_promedio_tranvias  double,
  tiempo_promedio_mobibuses double,
  tasa_reservas_asignadas   double,
...
create table usuario (
  ...
  constraint uq_usuario_user unique (user),
