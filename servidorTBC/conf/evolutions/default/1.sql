...
alter table posicion add constraint fk_posicion_tranvia_1 foreign key (tranvia_id) references tranvia (id);
create index ix_posicion_tranvia_1 on posicion (tranvia_id);
alter table posicion add constraint fk_posicion_vcub_2 foreign key (vcub_id) references vcub (id);
create index ix_posicion_vcub_2 on posicion (vcub_id);
alter table posicion add constraint fk_posicion_mobibus_3 foreign key (mobibus_id) references mobibus (id);
create index ix_posicion_mobibus_3 on posicion (mobibus_id);
alter table reserva add constraint fk_reserva_ruta_4 foreign key (ruta_id) references ruta (id);
create index ix_reserva_ruta_4 on reserva (ruta_id);
alter table reserva add constraint fk_reserva_usuario_5 foreign key (usuario_numero_identificacion) references usuario (numero_identificacion);
create index ix_reserva_usuario_5 on reserva (usuario_numero_identificacion);
alter table revision add constraint fk_revision_tranv_6 foreign key (tranvia_id) references tranvia (id);
create index ix_revision_tranv_6 on revision (tranvia_id);
alter table revision add constraint fk_revision_mobi_7 foreign key (mobibus_id) references mobibus (id);
create index ix_revision_mobi_7 on revision (mobibus_id);
alter table ruta add constraint fk_ruta_bus_8 foreign key (mobibus_id) references mobibus (id);
create index ix_ruta_bus_8 on ruta (mobibus_id);
alter table ruta add constraint fk_ruta_tranvia_9 foreign key (tranvia_id) references tranvia (id);
create index ix_ruta_tranvia_9 on ruta (tranvia_id);
alter table ruta add constraint fk_ruta_conductor_10 foreign key (conductor_numero_identificacion) references conductor (numero_identificacion);
create index ix_ruta_conductor_10 on ruta (conductor_numero_identificacion);
alter table vcub add constraint fk_vcub_usuario_11 foreign key (usuario_numero_identificacion) references usuario (numero_identificacion);
create index ix_vcub_usuario_11 on vcub (usuario_numero_identificacion);
alter table vcub add constraint fk_vcub_estacion_12 foreign key (estacion_id) references estacion (id);
